let dni= 36765496;
while (true){
    let ingreso = prompt("Ingrese su DNI para ver su resumen");
...
while (sueldoFinal > 0){
    ...
    switch (sueldoAhorro) {
        case 1:
            console.log("Tus ahorros mensuales serán de $" + (sueldoFinal * 0.1));
            break;
        case 2:
            console.log("Tus ahorros mensuales serán de $" + (sueldoFinal * 0.2));
            break;
        case 3:
            console.log("Tus ahorros mensuales serán de $" + (sueldoFinal * 0.3));
            break;
        case 4:
            console.log("Tus ahorros mensuales serán de $" + (sueldoFinal * 0.4));
            break;
        case 5:
            console.log("Tus ahorros mensuales serán de $" + (sueldoFinal * 0.5));
            break;
        case 6:
